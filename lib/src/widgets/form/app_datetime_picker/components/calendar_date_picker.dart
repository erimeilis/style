...
class _DatePickerModeToggleButtonState extends State<_DatePickerModeToggleButton> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final Color controlColor = theme.colors.white;
                      ...
                      children: <Widget>[
                        Flexible(
                          child: Text(
                            ...
                            style: theme.typography.p18.copyWith(
                              color: controlColor,
                            ),
                          ),
                        ),
...
class _MonthPickerState extends State<_MonthPicker> {
  ...
  Widget build(BuildContext context) {
    final theme = AppTheme.of(context);
    final Color controlColor = theme.colors.btnHighlight;
...
class _DayPickerState extends State<_DayPicker> {
  ...
  Widget build(BuildContext context) {
    final theme = AppTheme.of(context);
    //final ColorScheme colorScheme = Theme.of(context).colorScheme; //remove!
    //final TextTheme textTheme = Theme.of(context).textTheme; //remove!
    final MaterialLocalizations localizations = MaterialLocalizations.of(context);
    final TextStyle headerStyle = theme.typography.p18.copyWith(color: theme.colors.click);
    final TextStyle dayStyle = theme.typography.p18;
    final Color enabledDayColor = theme.colors.white;
    final Color disabledDayColor = theme.colors.icons;
    final Color selectedDayColor = theme.colors.white;
    final Color selectedDayBackground = theme.colors.btnHighlight;
    final Color todayColor = theme.colors.white;
...
class _YearPickerState extends State<YearPicker> {
  ...
  Widget _buildYearItem(BuildContext context, int index) {
    ...
    if (isSelected) {
      ...
      textColor = theme.colors.icons;
    } else if (isCurrentYear) {
      textColor = theme.colors.white;
    } else {
      textColor = theme.colors.white;
    }
    final TextStyle itemStyle = theme.typography.p18.copyWith(color: textColor);

    BoxDecoration? decoration;
    if (isSelected) {
      decoration = BoxDecoration(
        color: theme.colors.btnHighlight,
