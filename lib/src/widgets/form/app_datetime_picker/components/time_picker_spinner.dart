        ...
        child: ListView.builder(
          itemBuilder: (context, index) {
            ...
            return Container(
              ...
              child: AppText.p18(
                text,
                color: selectedIndex == index ? AppTheme.of(context).colors.white : AppTheme.of(context).colors.icons,
              ),
            );
          },
        ...
        child: ListView.builder(
          itemBuilder: (context, index) {
            ...
            return Container(
              ...
              child: AppText.p18(
                text,
                color: currentSelectedAPIndex == index ? AppTheme.of(context).colors.white : AppTheme.of(context).colors.grey,
              ),
            );
          },
