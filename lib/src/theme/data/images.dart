...
class AppImagesData extends Equatable {
  ...
  factory AppImagesData.regular({required PictureProvider appLogo}) => AppImagesData(
        appLogo: appLogo,
        backgroundPattern: const AssetImage(
          'assets/img/background_pattern.png',
          package: 'style',
        ),
      );

  factory AppImagesData.highContrast({required PictureProvider appLogo}) => AppImagesData(
        appLogo: appLogo,
